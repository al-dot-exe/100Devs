...
function shark(pontoonDistance, sharkDistance, youSpeed, sharkSpeed, dolphin){
  ...
  const sharkTimeToPontoon = sharkDistance / sharkSpeed;
  const youTimeToPontoon = pontoonDistance / youSpeed;
  
  return sharkTimeToPontoon > youTimeToPontoon ? "Alive!" : "Shark Bait!";
}
