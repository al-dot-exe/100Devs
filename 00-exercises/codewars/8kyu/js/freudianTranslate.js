...
// and so he digged to the root of their desires. This led to some of the most important psychoanalytic theories 
...
// SOLUTION 
// We can take full advantage of empty strings being falsey values in js
const toFreud = string => string.split(' ').map(str => str ? str = 'sex': str).join(' ');
